...
acting as another leaderboard. These product-level interaction and hierarchy
rules are accepted and frozen for Phase 7D.2; incidental CSS details are not.
